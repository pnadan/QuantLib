...
test_suite* HybridHestonHullWhiteProcessTest::suite(SpeedLevel speed) {
    ...
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testBsmHullWhiteEngine));
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testCompareBsmHWandHestonHW));
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testZeroBondPricing));
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testMcVanillaPricing));
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testMcPureHestonPricing));
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testAnalyticHestonHullWhitePricing));
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testCallableEquityPricing));
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testDiscretizationError));
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testFdmHestonHullWhiteEngine));
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testBsmHullWhitePricing));
    suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testH1HWPricingEngine));

    if (speed <= Fast) {
        suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testSpatialDiscretizatinError));
    }

    if (speed == Slow) {
        suite->add(QUANTLIB_TEST_CASE(HybridHestonHullWhiteProcessTest::testHestonHullWhiteCalibration));
    }
