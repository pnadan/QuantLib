...
test_suite* LowDiscrepancyTest::suite() {
    ...
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testRandomizedLattices));
	
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testSeedGenerator));

    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testPolynomialsModuloTwo));
    ...
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testMersenneTwisterDiscrepancy));
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testPlainHaltonDiscrepancy));
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testRandomStartHaltonDiscrepancy));
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testRandomShiftHaltonDiscrepancy));
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testRandomStartRandomShiftHaltonDiscrepancy));
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testUnitSobolDiscrepancy));
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testJackelSobolDiscrepancy));
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testSobolLevitanSobolDiscrepancy));
    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testSobolLevitanLemieuxSobolDiscrepancy));

    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testSobolSkipping));

    suite->add(QUANTLIB_TEST_CASE(LowDiscrepancyTest::testRandomizedLowDiscrepancySequence));
