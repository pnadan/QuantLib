...
test_suite* SwaptionVolatilityMatrixTest::suite() {
    ...
    suite->add(QUANTLIB_TEST_CASE(SwaptionVolatilityMatrixTest::testSwaptionVolMatrixCoherence));

    suite->add(QUANTLIB_TEST_CASE(SwaptionVolatilityMatrixTest::testSwaptionVolMatrixObservability));
