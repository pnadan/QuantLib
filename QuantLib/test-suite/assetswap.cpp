...
test_suite* AssetSwapTest::suite() {
    ...
    suite->add(QUANTLIB_TEST_CASE(AssetSwapTest::testSpecializedBondVsGenericBond));
    suite->add(QUANTLIB_TEST_CASE(AssetSwapTest::testSpecializedBondVsGenericBondUsingAsw));
