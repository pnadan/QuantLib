...
test_suite* RangeAccrualTest::suite() {
    ...
    suite->add(QUANTLIB_TEST_CASE(RangeAccrualTest::testPriceMonotonicityWithRespectToLowerStrike));
    suite->add(QUANTLIB_TEST_CASE(RangeAccrualTest::testPriceMonotonicityWithRespectToUpperStrike));
    return suite;
}
