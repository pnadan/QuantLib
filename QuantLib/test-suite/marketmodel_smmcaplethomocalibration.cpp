...
test_suite* MarketModelSmmCapletHomoCalibrationTest::suite() {
    ...
    suite->add(QUANTLIB_TEST_CASE(MarketModelSmmCapletHomoCalibrationTest::testFunction));
    suite->add(QUANTLIB_TEST_CASE(MarketModelSmmCapletHomoCalibrationTest::testPeriodFunction));
    #endif

    // FLOATING_POINT_EXCEPTION
    suite->add(QUANTLIB_TEST_CASE(MarketModelSmmCapletHomoCalibrationTest::testSphereCylinder));
