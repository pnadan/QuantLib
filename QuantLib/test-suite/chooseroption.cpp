...
test_suite* ChooserOptionTest::suite() {
    ...
    suite->add(QUANTLIB_TEST_CASE(ChooserOptionTest::testAnalyticSimpleChooserEngine));
    suite->add(QUANTLIB_TEST_CASE(ChooserOptionTest::testAnalyticComplexChooserEngine));
