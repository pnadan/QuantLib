...
void InflationVolTest::testYoYPriceSurfaceToATM() {
    BOOST_TEST_MESSAGE("Testing conversion from YoY cap-floor surface to YoY inflation term structure...");
...
boost::unit_test_framework::test_suite* InflationVolTest::suite() {
    ...
    boost::unit_test_framework::test_suite* suite = BOOST_TEST_SUITE("yoyOptionletStripper (yoy inflation vol) tests");
