...
test_suite* TqrEigenDecompositionTest::suite() {
    ...
    suite->add(QUANTLIB_TEST_CASE(TqrEigenDecompositionTest::testEigenValueDecomposition));
    suite->add(QUANTLIB_TEST_CASE(TqrEigenDecompositionTest::testZeroOffDiagEigenValues));
    suite->add(QUANTLIB_TEST_CASE(TqrEigenDecompositionTest::testEigenVectorDecomposition));
