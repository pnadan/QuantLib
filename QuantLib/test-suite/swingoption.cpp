...
test_suite* SwingOptionTest::suite(SpeedLevel speed) {
    ...
    suite->add(QUANTLIB_TEST_CASE(SwingOptionTest::testExtendedOrnsteinUhlenbeckProcess));
    suite->add(QUANTLIB_TEST_CASE(SwingOptionTest::testFdBSSwingOption));
    suite->add(QUANTLIB_TEST_CASE(SwingOptionTest::testFdmExponentialJump1dMesher));

    if (speed <= Fast) {
        suite->add(QUANTLIB_TEST_CASE(SwingOptionTest::testExtOUJumpVanillaEngine));
        suite->add(QUANTLIB_TEST_CASE(SwingOptionTest::testExtOUJumpSwingOption));
    }
