...
test_suite* ExtensibleOptionsTest::suite() {
    ...
    suite->add(QUANTLIB_TEST_CASE(ExtensibleOptionsTest::testAnalyticHolderExtensibleOptionEngine));
    suite->add(QUANTLIB_TEST_CASE(ExtensibleOptionsTest::testAnalyticWriterExtensibleOptionEngine));
